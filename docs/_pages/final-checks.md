...
<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-checks/requirements.png" alt="Front view of OSSMM headband" style="width: 40%;">
...
<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-checks/find-device.png" alt="Front view of OSSMM headband" style="width: 40%;">
...
6. Connect the OSSMM device.
 a. The green LED will flash several for a successful connection.
 
<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-checks/connect.png" alt="Front view of OSSMM headband" style="width: 40%;">
...
8. View the Accelorometer and Gyroscope and verify plots show turning of the head.



<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-checks/acc-gyro.png" alt="Front view of OSSMM headband" style="width: 40%;">
...
9. View the EOG section, and verify eye movement is detect with side-to-side saccades or roll your eyes.

In the plot below you can observe left-right saccade, right-left saccade, and clock-wise eye movement.

<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-checks/eog.png" alt="Front view of OSSMM headband" style="width: 40%;">
  <figcaption style="text-align: center; font-style: italic; margin-top: 5px;">Eye Movement (EOG) plot in Live Data section. Arrows point to distinct eye momvents: left-right saccade, right-left saccade, eye rolling.</figcaption>
</figure>
<br>
...
<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-checks/pulse.png" alt="Front view of OSSMM headband" style="width: 40%;">
...
<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-checks/stop.png" alt="Front view of OSSMM headband" style="width: 40%;">
...
<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-checks/reconnect.png" alt="Front view of OSSMM headband" style="width: 40%;">
...
<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-assembly/data-protection.png" alt="Front view of OSSMM headband" style="width: 40%;">
...
<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-assembly/password.png" alt="Front view of OSSMM headband" style="width: 40%;">
  <figcaption style="text-align: center; font-style: italic; margin-top: 5px;">Semi-randomnly generated OSSMM password for encrypted recording files.</figcaption>
</figure>
...
<br>
<figure>
  <img src="{{ site.url }}/OSSMM/media/final-assembly/modulation.png" alt="Front view of OSSMM headband" style="width: 40%;">
  <figcaption style="text-align: center; font-style: italic; margin-top: 5px;">"Modulation Mode" Toggle" Toggle and "Test" button in Sleep Modulation section.</figcaption>
</figure>
